...
var toppings_objects = {"pepperoni": [], "mushroom": [], "onion": [], "green": [], "pineapple": []}
var toppings = {"pepperoni": 0, "mushroom": 0, "onion": 0, "green": 0, "pineapple": 0}
...
@onready var green_num_label: Label = $"../GreenNumLabel"
@onready var pineapple_num_label: Label = $"../PineappleNumLabel"

func _ready() -> void:
	pizza_init_pos = pizza.global_position

func managerSetEquations(pep, mush, onion, green, pine):
	get_parent().setSpecificEquations(pep, mush, onion, green, pine)
...
func updateToppingNumLabels() -> void:
	...
	green_num_label.text = str(toppings["green"])
	pineapple_num_label.text = str(toppings["pineapple"])

func clear_all() -> void:
	#print("cleared all")
	toppings_objects = {"pepperoni": [], "mushroom": [], "onion": [], "green": [], "pineapple": []}
	toppings = {"pepperoni": 0, "mushroom": 0, "onion": 0, "green": 0, "pineapple": 0}
	for child in toppings_container.get_children():
		child.queue_free()
	line_edit.text = "0"
	toppings = {"pepperoni": 0, "mushroom": 0, "onion": 0, "green": 0, "pineapple": 0}
	get_parent().resetCheckmarks()
	updateToppingNumLabels()
